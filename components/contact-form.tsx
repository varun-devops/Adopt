    ...
    <section>
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 pt-32">
        ...
        <div className="py-12 md:py-20">
          {/* Contact heading with illustration */}
          <div className="flex flex-wrap items-center justify-between mb-16">
            ...
            <div className="w-full lg:w-1/2 flex justify-center" data-aos="zoom-in">
              <div className="relative">
                <div className="absolute -top-10 left-1/2 w-60 h-60"></div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-3 bg-gray-800/50 border border-gray-700 rounded-lg   focus:outline-none focus:ring-2 focus:ring-indigo-500"
                ...
                <button
                  type="submit"
                  className="w-full flex items-center justify-center px-6 py-4 bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700   font-medium rounded-lg shadow-lg transition-all duration-300"
                >
          ...
          {/* Contact Details - now below the form */}
          <div className="max-w-4xl mx-auto" data-aos="fade-up">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {/* Office Address */}
              <div className="backdrop-blur-sm bg-gray-900/30 p-6 rounded-2xl border border-gray-700/50 shadow-xl">
                <h3 className="text-xl font-semibold   mb-4">Office Address</h3>
                <div className="flex items-start">
                  <div className="bg-gradient-to-r from-red-500/20 to-indigo-600/20 p-3 rounded-full mr-4 flex-shrink-0">
              ...
              <div className="backdrop-blur-sm bg-gray-900/30 p-6 rounded-2xl border border-gray-700/50 shadow-xl">
                ...
                <div className="flex items-center">
                  ...
                  <a href="mailto:info@faad.in" className="text-gray-300 hover: ">info@faad.in</a>
                </div>
              </div>
              ...
              <div className="backdrop-blur-sm bg-gray-900/30 p-6 rounded-2xl border border-gray-700/50 shadow-xl">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <a href="#" className="flex items-center text-gray-300 hover:  text-sm">
                    <div className="bg-gradient-to-r from-red-500/20 to-indigo-600/20 p-2 rounded-full mr-2 flex-shrink-0">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-indigo-500" fill="currentColor" viewBox="0 0 24 24">
